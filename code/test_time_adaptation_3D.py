...
parser.add_argument('--source_checkpoint', type=str,
                    default='/mnt/data1/ZhouFF/TTA4MIS/model/BraTs2023_Fully_Supervised_GLI/unet_3D/iter_27000_dice_0.7735.pth', help='The source domain checkpoint')
...
def train(args, snapshot_path):
    ...
    for i_batch, sampled_batch in enumerate(trainloader):
        ...
        print("Adaptated Case:",sampled_batch['name'])
